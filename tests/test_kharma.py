...
def test_kharma_const_vanilla():
    ...
    evaluated_expression = kharma.resolve(const_vanilla)
...
def test_kharma_variable_vanilla():
    ...
    evaluated_expression = kharma.resolve(variable_vanilla)
...
def test_kharma_variable_anchor_variable():
    ...
    evaluated_expression = kharma.resolve(variable_anchor_variable)
    assert evaluated_expression == "variable vanilla"
...
def test_kharma_variable_element():
    ...
    evaluated_expression = kharma.resolve(variable_element)
...
def test_kharma_variable_anchor_import_constant():
    ...
    evaluated_expression = kharma.resolve(variable_anchor_import_constant)
...
def test_kharma_variable_anchor_import_variable():
    ...
    evaluated_expression = kharma.resolve(variable_anchor_import_variable)
...
def test_kharma_variable_anchor_import_function():
    ...
    evaluated_expression = kharma.resolve(variable_anchor_import_function)
...
def test_kharma_variable_function():
    ...
    evaluated_expression = kharma.resolve(variable_function)
...
def test_kharma_variable_regexp():
    ...
    evaluated_expression = kharma.resolve(variable_regexp)
...
def test_kharma_variable_range():
    ...
    evaluated_expression = kharma.resolve(variable_range)
...
def test_kharma_variable_repeat():
    ...
    evaluated_expression = kharma.resolve(variable_repeat)
...
def test_kharma_variable_repeat_nodup():
    ...
    evaluated_expression = kharma.resolve(variable_repeat_nodup)
...
def test_main():
    ...
    evaluated_expression = kharma.resolve(main)
    assert evaluated_expression == "variable vanilla"
